    ...
    <div className="grid grid-cols-1 gap-10 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
      <div className="">
        ...
        <div className="text-3xl border-4 border-gray-500 rounded-xl p-0 bg-white shadow-2xl hover:cursor-pointer hover:text-black hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-center hover:-translate-y-1 transition-all duration-300 ease-in-out">
          <Haircard1 />
          <p className="text-center text-2xl mt-2 mb-2 bg-">Bob Cut</p>
        </div>
      </div>
      <div>
        ...
        <div className="text-3xl border-4 border-gray-500 rounded-xl p-0 bg-white shadow-2xl hover:cursor-pointer hover:text-black hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-center hover:-translate-y-1 transition-all duration-300 ease-in-out">
          <Haircard2 />
          <p className="text-center text-2xl mt-2 mb-2">Pixie Cut</p>
        </div>
      </div>
      <div>
        ...
        <div className="text-3xl border-4 border-gray-500 rounded-xl p-0 bg-white shadow-2xl hover:cursor-pointer hover:text-black hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-center hover:-translate-y-1 transition-all duration-300 ease-in-out">
        <Haircard3 />
          <p className="text-center text-2xl mt-2 mb-2">Layered Lockst</p>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="text-3xl border-4 border-gray-500 rounded-xl p-0 bg-white shadow-2xl hover:cursor-pointer hover:text-black hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-center hover:-translate-y-1 transition-all duration-300 ease-in-out">
        <Haircard5 />
          <p className="text-center text-2xl mt-2 mb-2">LongBob Cut</p>
        </div>
      </div>
      <div>
        ...
        <div className="text-3xl border-4 border-gray-500 rounded-xl p-0 bg-white shadow-2xl hover:cursor-pointer hover:text-black hover:shadow-lg focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-center hover:-translate-y-1 transition-all duration-300 ease-in-out">
        <Haircard6 />
          <p className="text-center text-2xl mt-2 mb-2">Wedge Hair</p>
        </div>
      </div>
